...
selection_fig = uifigure('Name', [disturbance_label ' Function Type'], 'Position', [500, 300, 300, 220]);
selection_fig.Color = appColors.background;

% Add title panel with enhanced styling
titlePanel = uipanel(selection_fig, 'Position', [10 170 280 40], 'BackgroundColor', appColors.panelHeader, 'BorderType', 'none');
...
contBtn = uibutton(selection_fig, 'push', 'Position', [50, 110, 200, 50], ...
...
pieceBtn = uibutton(selection_fig, 'push', 'Position', [50, 50, 200, 50], ...
...
cancelBtn = uibutton(selection_fig, 'push', 'Position', [100, 10, 100, 30], ...
    'Text', 'Cancel', ...
    'FontSize', 12, ...
