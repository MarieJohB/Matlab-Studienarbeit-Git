function [disturbance, num_sections, start_time, end_time] = get_disturbance_input_version3(disturbance_label)
    ...
    % Local function for continuous function input
    function continuous_function_input(selection_fig)
        ...
        cont_fig = uifigure('Name', [disturbance_label ' Continuous Function Input'], 'Position', [400, 300, 600, 450]);
        ...
        % Function input - with the appropriate label
        uilabel(cont_fig, 'Text', [disturbance_label ':'], 'Position', [150, 100, 40, 22]);
    ...
    % Local function for piecewise function input
    ...
    % Local function to preview continuous function
    ...
    % Local function to preview piecewise function
    ...
    % Local function to confirm continuous function
    function confirmContinuousFunction(selection_fig, cont_fig, startField, endField, stepField, funcField)
        ...
        try
            ...
            % Create function handle
            disturbance_value = convertStringToFunctionHandle(funcStr);
    ...
    % Local function to confirm piecewise function
    function confirmPiecewiseFunction(selection_fig, piece_fig, pieceTable)
        ...
        try
            ...
            for i = 1:num_sections
                funcStr = data{i, 4};
                disturbance_value{i} = convertStringToFunctionHandle(funcStr);
            end
    ...
    % Helper function to convert string to function handle
    function f = convertStringToFunctionHandle(funcStr)
        % Convert a string to a function handle
        ...
        try
            ...
            if contains(funcStr, 't')
                ...
                % Create function handle for constant value
    ...
    % Helper function to handle figure closed event
