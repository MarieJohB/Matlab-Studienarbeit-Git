...
cont_fig = uifigure('Name', [disturbance_label ' Function Input'], 'Position', [400, 200, 600, 500]);
...
function showHelpDialog()
    ...
    helpTitleLabel = uilabel(helpTitlePanel, 'Text', 'Disturbance Function Input Reference', ...
