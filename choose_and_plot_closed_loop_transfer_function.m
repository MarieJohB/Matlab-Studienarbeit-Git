function choose_and_plot_closed_loop_transfer_function(L)
    ...
    TF_Type = menu('Choose a closed-loop transfer function to plot:', ...
                   'Y/R (Input to Output) - G_{yr}(s)', ...
                   'Y/H (Disturbance to Output) - G_{yh}(s)', ...
                   'Y/D1 (Disturbance 1 to Output) - G_{yd1}(s)', ...
                   'Y/D2 (Disturbance 2 to Output) - G_{yd2}(s)', ...
                   'U/R (Input to Control Effort) - G_{ur}(s)', ...
                   'U/H (Disturbance to Control Effort) - G_{uh}(s)', ...
                   'E/R (Input to Error) - G_{er}(s)', ...
                   'E/H (Disturbance to Error) - G_{eh}(s)', ...
                   'E/D1 (Disturbance 1 to Error) - G_{ed1}(s)', ...
                   'E/D2 (Disturbance 2 to Error) - G_{ed2}(s)', ...
                   'U/D1 (Disturbance 1 to Control Effort) - G_{ud1}(s)', ...
                   'U/D2 (Disturbance 2 to Control Effort) - G_{ud2}(s)');
