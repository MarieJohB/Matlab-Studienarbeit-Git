...
piece_fig = uifigure('Name', 'Piecewise Reference Signal Input', 'Position', [300, 150, 800, 650]);
...
buttonPanel = uipanel(piece_fig, 'Title', 'Actions', ...
    'Position', [10 20 780 120], 'TitlePosition', 'centertop', ...
    'FontWeight', 'bold', 'FontSize', 14, 'BackgroundColor', appColors.panelBg);
...
% Preview button
previewButton = uibutton(buttonPanel, 'push', 'Position', [startX, 60, buttonWidth, 30], ...
    'Text', 'Preview', ...
    'FontSize', 12, ...
...
% Confirm button
confirmButton = uibutton(buttonPanel, 'push', 'Position', [startX + buttonWidth + spacing, 60, buttonWidth, 30], ...
    'Text', 'Confirm', ...
    'FontSize', 12, ...
...
% Cancel button
cancelButton = uibutton(buttonPanel, 'push', 'Position', [startX + 2*(buttonWidth + spacing), 60, buttonWidth, 30], ...
    'Text', 'Cancel', ...
    'FontSize', 12, ...
...
helpBtn = uibutton(buttonPanel, 'push', 'Text', 'Help', ...
    'Position', [startX + buttonWidth + spacing, 25, buttonWidth, 30], ...
    'BackgroundColor', appColors.buttonPrimary, ...
    'FontColor', appColors.lightText, ...
    'FontSize', 12, ...
